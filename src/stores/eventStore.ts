  ...
  loadMockEvents: () => {
    ...
    const mockEvents: HighwayEvent[] = [
      ...
      },
      {
        ...
        coordinates: [106.556, 29.542],  // 南侧偏中
      ...
      },
      {
        ...
        coordinates: [106.547, 29.581],  // 北侧偏西
      ...
      // ---- 低危 (面状散布) ----
      {
        ...
        coordinates: [106.575, 29.565],  // 东侧偏南
        source: 'camera', sourceDetail: '摄像头 + 高德路况',
      ...
      },
      {
        ...
        coordinates: [106.535, 29.542],  // 西南角
      ...
      },
      {
        ...
        coordinates: [106.564, 29.548],  // 南侧偏东
